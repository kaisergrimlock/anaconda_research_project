...
#"qwen.qwen3-32b-v1:0"
MODELS = ["openai.gpt-oss-20b-1:0"]  # e.g. qwen.qwen3-32b-v1:0, openai.gpt-oss-20b-1:0, "llama3-8b-instruct"
INFERENCE_CONFIG = {"maxTokens": 20000, "temperature": 0.0, "topP": 1.0}
