...
# =========================
TREC_DL_YEAR = "2022"
MODEL = "llama3-70b-instruct"   # e.g. "gpt-oss-20b", "qwen3-32b-v1", ...
...
FIG_PATH = FIG_DIR / f"nonrelpairs_{MODEL}_{TREC_DL_YEAR}_decompose_llm.png"
...
TARGET_LANGS: List[str] = ["raw_crit"]
