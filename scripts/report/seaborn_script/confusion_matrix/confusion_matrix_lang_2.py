...
# -------- Config --------
TREC_DL_YEAR = "2022"
MODEL = "llama3-70b-instruct"  # e.g., "qwen3-32b-v1", "gpt-oss-20b", etc.
LANG  = "raw"  # "raw","eng","vi","fr", etc.

# This CSV is now assumed to already contain:
#   - relevance
#   - llm_relevance
LLM_FILE = Path("outputs/llm_label") / f"trec_dl_{TREC_DL_YEAR}" / MODEL / f"{MODEL}_trecdl_{TREC_DL_YEAR}_{'raw' if LANG=='raw' else LANG}_labels.csv"
