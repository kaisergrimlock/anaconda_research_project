...
Supports two configurable language suffix groups, e.g.:
...
def write_latex_table(
    ...
    lines.append(
        r"\caption{Total False Positive (FP) and False Negative (FN) rates across TREC-DL 2021 and 2022.}"
    )
