...
OUT_ANOVA_TEX = OUT_DIR / f"anova_language_model_{TREC_DL_YEAR}.tex"
...
def main() -> None:
    ...
    latex = to_latex_table(
        anova_df,
        caption=f"Two-way ANOVA for mean difference of labels with model and language as factors on TREC-DL {TREC_DL_YEAR}.",
