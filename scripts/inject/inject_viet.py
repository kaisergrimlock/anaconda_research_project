...
INPUT_FILE = Path("outputs/trec_dl/combined_irrelevant_results_100.csv")
OUTPUT_FILE = Path("outputs/trec_dl/translated_data/combined_result_translated_"+ TARGET_LANG +"_100.csv")
# ==============================
