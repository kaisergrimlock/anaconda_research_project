...
INPUT_FILE = Path("outputs/trec_dl/retrieved/trecdl_passage_2019_combined.csv")
OUTPUT_FILE = Path("outputs/trec_dl/translated_data/combined_result_translated_"+ TARGET_LANG +"_250.csv")
# ==============================
