...
INPUT_CSV   = Path("outputs/trec_dl/combined_result_translated_gibberish_20.csv")

OUTPUT_DIR  = Path("outputs/trec_dl_llm_label/translated/gibberish")   # CSV outputs per run/model
